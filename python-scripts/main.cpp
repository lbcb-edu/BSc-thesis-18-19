...
int main(int argc, char** argv) {
    ...
    // KK: Robijev tip!!
	std::sort(sequences.begin(), sequences.end(), [](const std::unique_ptr<spoa::Sequence>& lhs, const std::unique_ptr<spoa::Sequence>& rhs){return lhs->data().size() > rhs->data().size();});
